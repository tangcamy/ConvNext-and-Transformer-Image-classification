...
#特徵共享&三個預測值
class ResNet50_sharefeature(nn.Module):
    ...
    def __init__(self, use_cbam=True, image_depth=3, num_classes=[2,4,14]):#三層階層
        ...
        '''
        super(ResNet50_sharefeature, self).__init__()

        self.in_channels = 64 
        self.expansion = 4
        #self.num_blocks = [3, 4, 6, 3]#for 50
        self.num_blocks = [3, 4, 23, 3]#for 101
...
class ResNet50_muti(nn.Module):
    ...
    def __init__(self, use_cbam=True, image_depth=3, num_classes=[2,4,14]):#三層階層
        '''Params init and build arch.
        '''
        super(ResNet50_muti, self).__init__()
    ...
    def forward(self, x): #__call__ #x:input_batch
        ...
        level_3 = self.softmax_reg3(self.linear_lvl3(x))# add layer3
...
class ResNet50_muti(nn.Module):
    ...
    def __init__(self, use_cbam=True, image_depth=3, num_classes=[2]):#三層階層
        '''Params init and build arch.
        '''
        super(ResNet50_muti, self).__init__()
